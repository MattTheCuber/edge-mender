...
3. Create a virtual environment using `uv venv --python 3.13`
4. Install all development dependencies using `uv sync --all-extras`
5. Open the [`example.ipynb`](example.ipynb) notebook
6. Run the cells one-by-one

### Full Evaluation (WARNING: This will take several hours)

1. Open the [evaluation notebook](results/evaluate.ipynb)
2. Run all cells
3. See the results in the [`results`](results) folder
